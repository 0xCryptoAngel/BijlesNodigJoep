<template>
    ...
    <div class="relative z-20 shadow">
      ...
      >
        ...
        <div class="-my-2 -mr-2 md:hidden">
          <button
            type="button"
            class="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-light-blue-500"
        ...
        >
          <nav class="flex space-x-10">
            <div class="relative">
              ...
              <button
                type="button"
                class="inline-flex items-center text-base font-medium text-gray-500 bg-white rounded-md group hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-blue-500"
                @click="isMobileMenuOpen = !isMobileMenuOpen"
              >
          ...
          <div class="flex items-center md:ml-12">
            ...
            <a
              href="/register"
              class="inline-flex items-center justify-center px-4 py-2 ml-8 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-light-blue-600 hover:bg-light-blue-700"
            >
              Registreren
            </a>
          </div>
  ...
  -->
    <div
      v-if="flyOverMenu"
      class="absolute inset-x-0 z-10 hidden transform shadow-lg md:block"
    >
      <div class="bg-white">
        <div
          ...
          >
            <div class="flex md:h-full lg:flex-col">
              <div class="flex-shrink-0">
                <span
                  class="inline-flex items-center justify-center w-10 h-10 text-white rounded-md bg-light-blue-500 sm:h-12 sm:w-12"
                >
              ...
              >
                ...
                <p class="mt-2 text-sm font-medium text-light-blue-600 lg:mt-4">
      ...
      <div class="relative grid grid-cols-1 mx-auto max-w-7xl lg:grid-cols-2">
        ...
        <div class="px-4 py-8 bg-gray-50 sm:py-12 sm:px-6 lg:px-8 xl:pl-12">
          ...
          <div class="mt-6 text-sm font-medium">
            <a href="#" class="text-light-blue-600 hover:text-light-blue-500">
