<template>
  <div>
    ...
    <div class="h-20 mb-10 bg-white">
      <div
        class="flex items-center flex-1 h-full px-4 py-6 mx-auto max-w-8xl sm:px-4 lg:px-8"
      >
        <h1
          class="float-left pl-0 m-0 text-2xl font-medium leading-5 text-orange-500 whitespace-nowrap overflow-ellipsis"
        >
          <b class="text-black">123</b> Bijlesgevers
          <span class="text-black outline-none">op postcode</span> 4516CZ
        </h1>

        <div
          class="flex items-center float-right pl-10 ml-auto outline-none whitespace-nowrap"
        >
          <p class="mr-3 text-xs font-semibold text-gray-400 uppercase">
            sorteren op
          </p>
          <button
            id="sort-menu"
    ...
    <div class="relative min-h-calc"></div>
...
export default {
  name: 'Zoeken',
  components: { tutorItem, BaseGrid, BreadcrumbsApp },
