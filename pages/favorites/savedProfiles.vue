          ...
          <aside class="py-6 lg:col-span-3">
            <nav>
              ...
              >
                ...
                <span class="truncate"> Recent bekeken </span>
              </NuxtLink>

              <NuxtLink
                to="/favorites/savedprofiles"
              ...
              >
                ...
                <span class="truncate"> Opgeslagen profielen </span>
              </NuxtLink>
            </nav>
          </aside>
            ...
            <div class="px-4 py-6 space-y-6 sm:p-6 lg:pb-8">
              ...
              >
                <div class="flex-grow space-y-6">
                  ...
                  <h3 v-else>Je hebt geen opgeslagen profielen</h3>
                </div>
              </div>
            </div>
          </form>
